...
hysteria_upgrade(){
    bash <(curl https://raw.githubusercontent.com/behrouz-atoofi/SafeConnect/main/upgrade.sh)
}
...
display_main_menu() {
    ...
    echo -e "◇────────────────🚀 Welcome To SafeConnect Panel 🚀─────────────────◇"
    tput sgr0
    echo -e "${LPurple}◇──────────────────────────────────────────────────────────────────────◇${NC}"
...
# Function to display the SafeConnect menu
display_hysteria2_menu() {
    clear
    echo -e "${LPurple}◇──────────────────────────────────────────────────────────────────────◇${NC}"

    echo -e "${yellow}                   ☼ SafeConnect Menu ☼                   ${NC}"
